...
void MainWindow::on_pb_request_clicked()
{
    ...
    auto reqToDb = [this]{
        int typeRequest = requestAllFilms;
        QString selected = ui->cb_category->currentText();

        if (selected == "Все") typeRequest = requestAllFilms;
        else if (selected == "Комедия") typeRequest = requestComedy;
        else if (selected == "Ужасы") typeRequest = requestHorrors;



dataBase->RequestToDB(typeRequest);};
